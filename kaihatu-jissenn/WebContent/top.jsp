...
<title>${account.userName}のホームページ</title>
<style>
/*　　　　 cssのフレームワーク*/
...
<body class="">
	<div class="container">
		...
		<div id="content">
			...
			<div id="library">
				<h3>
					今選択している図書館: <strong id="pref_name"></strong>
				</h3>
				<br>
				...
				<div id="change_lib">
					<h3>
						あなたが登録した図書館: <strong id="pref_name"></strong>
					</h3>
					<button type="button" class="btn btn-outline-info">
						<a href="javascript:city_selector.showDlg();" class="alert-link">登録している図書館の変更</a>
					</button>
					<strong id="registration_library"> ${library.place}</strong>
				</div>
				...
				<table class="table">
					...
					<tbody>
						<c:forEach var="book" items="${bookList}">
							<tr>
								<td id="calil_booklist" class="clearfix">
										<img src="img/${book.isbn}.webp" width="65px" height="15%">
								</td>
								<td>${book.isbn}</td>
								<td>${book.title}</td>
								<td>${book.author}</td>
